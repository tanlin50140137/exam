...
{	
    ...
    exam.CreateHTML9=function()
    {
    	var tFlag = true;
    	if( this.setting9 != undefined )
    	{
	    	if( this.setting9.title != undefined )
	    	{
	    		tFlag = this.setting9.title;
	    	}
    	}
    	...
    	var div3  = '<div class="exam_rembershdiv4"><img src="'+lenImg+'" width="12" height="12" align="absmiddle"/>时长2小时</div>'; 
    		...
    		div3 += '<p class="exam_rembershp0">题型：<b>单选题</b> &nbsp; （ 共 <span class="exam_countall">10</span> 题 ）<span class="exam_rembershpspan0">考场编号（1534836323205235）&nbsp; 全国真题考试复习题 &nbsp; <img src="'+vipImg+'" width="21" height="21" align="absmiddle"/></span></p>';
    		div3 += '<p class="exam_rembershp1"><span>1.</span> （）项目关注的重点应是财务效益。</p>';
    		div3 += '<p class="exam_rembershp2">请选择答案：</p>';
    		
    		div3 += '<form id="exam_rembershform0">';
    		div3 += '<ul class="exam_rembershul0" style="margin: 0.6rem 0px 0px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;;">';
    		div3 += '<li class="exam_rembershli0" style="margin: 0px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;; list-style-type: none; line-height: 3rem; font-size: 13px; color: rgb(58, 56, 56);">';
    		div3 += '<label><input type="radio" name="rightkey" value="A">A.铁路</label>';
    		div3 += '</li>';
    		div3 += '<li class="exam_rembershli0" style="margin: 0px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;; list-style-type: none; line-height: 3rem; font-size: 13px; color: rgb(58, 56, 56);">';
    		div3 += '<label><input type="radio" name="rightkey" value="B">B.公共设施</label>';
    		div3 += '</li>';
    		div3 += '<li class="exam_rembershli0" style="margin: 0px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;; list-style-type: none; line-height: 3rem; font-size: 13px; color: rgb(58, 56, 56);">';
    		div3 += '<label><input type="radio" name="rightkey" value="C">C.社会福利</label>';
    		div3 += '</li>';
    		div3 += '<li class="exam_rembershli0" style="margin: 0px; padding: 0px; font-family: &quot;Microsoft YaHei&quot;; list-style-type: none; line-height: 3rem; font-size: 13px; color: rgb(58, 56, 56);">';
    		div3 += '<label><input type="radio" name="rightkey" value="D">D.高速公路</label>';
    		div3 += '</li>';
    		div3 += '</ul></form>';    		    		
    		div3 += '<p class="exam_rembershp3"><img src="'+seImg+'" width="20" height="20" align="absmiddle"> <font color="#00ce6d">请选择答案</font></p>';   		
    		div3 += '<div class="exam_rembershdiv3" style="margin: 1.2rem 0px 1rem; padding: 1rem 0px; text-align: center; font-family: &quot;Microsoft YaHei&quot;;">';
    		div3 += '<input type="button" class="exam_rembershbtn0" value="确定" />'; 
    		div3 += '<input type="button" class="exam_rembershbtn0" value="放弃" />';
    		div3 += '<input type="button" class="exam_rembershbtn0" value="上一题" />';
    		div3 += '<input type="button" class="exam_rembershbtn0" value="下一题" />';
    ...
    exam.CreateCss9=function()
    {
    	if( this.setting9 != undefined )
    	{
    		var width = exam.isEmptyObject(this.setting9.w)?'100%':this.setting9.w;
    		var height = exam.isEmptyObject(this.setting9.h)?'100%':this.setting9.h;
    		var colors = exam.isEmptyObject(this.setting9.color)?'#666666':this.setting9.color;
    		var bgcs = exam.isEmptyObject(this.setting9.bgcs)?'#fbf6f4':this.setting9.bgcs;
    	}
    	else
    	{
    		var width = '100%';
    	...
    	$(".exam_rembershdiv0").css({"border":"1px solid #d8cdcd","margin":"0","padding":"0","width":width,"height":height});
    	$(".exam_rembershdiv1").css({"margin":"0","padding":"0","padding":"0px 1.8rem","border-bottom":"1px solid #d8cdcd","height":"3.3rem","line-height":"3.3rem","font-family":"Microsoft YaHei","background":bgcs,"color":colors});  
    	$(".exam_rembershdiv1 a").css({"margin":"0","padding":"0","text-decoration":"none","color":"#3e3c3c","font-family":"Microsoft YaHei"});
    	$(".exam_rembershdiv2").css({"margin":"0","padding":"0px 1.8rem","position":"relative","top":"0","left":"0"});
    	$(".exam_rembershdiv4").css({"border":"1px solid #f1aceb","margin":"0","padding":"6px 20px","position":"absolute","top":"1rem","right":"2rem","font-family":"Microsoft YaHei","font-size":"13px","color":"#292828","border-radius":"4px","background":"#f1aceb"});
    	$(".exam_rembershdiv4-1").css({"border":"1px solid #ffe60e","margin":"0","padding":"6px 20px","position":"absolute","top":"1rem","right":"9.6rem","font-family":"Microsoft YaHei","font-size":"13px","color":"#ca5441","border-radius":"4px","background":"#ffe60e"});  	
    	$(".exam_rembershp0").css({"margin":"0","padding":"0","font-family":"Microsoft YaHei","line-height":"4rem","color":"#3a3838","height":"3rem","font-size":"15px"});
    	$(".exam_rembershpspan0").css({"float":"right","font-size":"12px","color":"#7b7878"});
    	$(".exam_rembershp1").css({"border-bottom":"1px solid #e8e0e0","margin":"0.6rem 0 0 0","padding":"0 0 1rem 0","font-family":"Microsoft YaHei","line-height":"2rem","font-size":"1.3rem","color":"#3a3838"});
    	$(".exam_rembershp2").css({"margin":"0","padding":"0","font-family":"Microsoft YaHei","line-height":"4rem","color":"#3a3838","height":"3rem","font-size":"13px"});   	
    	$(".exam_rembershul0").css({"margin":"0.6rem 0 0 0","padding":"0","font-family":"Microsoft YaHei"});
    ...
    {
    	this.htmlobj9 = hobj;
    	this.setting9 = (Sett==undefined)?{}:Sett;
    	exam.func9 = (func==undefined)?function(){}:func;
   	
    	var html = this.CreateHTML9();   	
    	
    	$( this.htmlobj9 ).empty();
    	$( this.htmlobj9 ).append( html );
