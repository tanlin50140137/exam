...
{	
    ...
    exam.CreateHTML8=function()
    {
    	...
    	if( this.setting8 != undefined )
    	{
    		...
    		exam.type = this.setting8.type==''?1:this.setting8.type;
    		exam.bel = this.setting8.bel==''?'':this.setting8.bel;
    	} 
    	...
    	var div1 = $('<div class="exam_insenablediv1"><img src="'+suImg+'" width="25" height="25" align="absmiddle"/>EXAM v1.0 - TanLin<img src="'+picImg+'" width="26" height="26" align="absmiddle"/> <span>Install step</span></div>');
    	
    	var div4 = $('<div class="exam_insenablediv4"><img src="'+urlImg+'" width="21" height="21" align="absmiddle"/>设置域名路径</div>');
    	var div5 = $('<div class="exam_insenablediv5"><input type="text" id="url" value="'+window.location.protocol+'//'+window.location.host+'"/> <span style="font-size:12px;">默认指向根目录，如果要安装在其它目录请定义路径（如：http://www.xxx.com/二级目录/或三级目录下）</span></div>');
    	
    	var div2 = $('<div class="exam_insenablediv2"><img src="'+prImg+'" width="21" height="21" align="absmiddle"/>目录权限</div>');
    	var div3 = $('<div class="exam_insenablediv3"><img src="'+dirImg+'" width="21" height="21" align="absmiddle"/>'+exam.dir+'<span>'+(exam.power=='0'?'权限不足':'ok')+'</span></div>');
    ...
    exam.CreateCss8=function()
    {
    	if( this.setting8 != undefined )
    	{
    		...
    		var bgcs = exam.isEmptyObject(this.setting8.bgcs)?'#fbf6f4':this.setting8.bgcs;
    	}
    	else
    	{
    		var width = '100%';
    	...
    	$(".exam_insenablediv5").css({"margin":"0 1.6rem","padding":"1rem 0","color":"#655e5e","font-family":"Microsoft YaHei"});
