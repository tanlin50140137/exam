	...
	if( !empty( $ify ) )
	{
		...
		if( !empty( $searchkc ) )
		{
			foreach( $searchkc as $k => $v )
			{
				...
				if( $v['tariff'] == 1 )
				{
					$li1 .='<li class="exam_minationli0"><a href="javascript:void(0);" target="'.$target.'" onclick="TollBox();">'.$mishu.'</a><p><img src="'.$examImg3.'" width="100" height="35" align="absmiddle"/><img src="'.$examImg5.'" width="40" height="35" align="absmiddle"/></p></li>';
				}
				else 
				{
	...
	if( !empty( $rows ) )
	{
		foreach( $rows as $k => $v )
		{
			...
			if( $id != $v['pid'] )
			{
				if( $v['tariff'] == 1 )
				{
					$li0 .= '<li class="exam_hottestli0"><a href="javascript:void(0);" target="'.$target.'">'.$mishu.'</a><p class="exam_hottestlip0"><img src="'.$hotImg2.'" width="100" height="35" align="absmiddle"/><img src="'.$hotImg5.'" width="40" height="35" align="absmiddle"/></p></li>';
				}
				else 
				{
